  ...
  <body>
    ...
    <header id="home" class="hero-area-2">    
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
          <a href="index.jsp" class="navbar-brand"><img src="../static/img/logo.png" alt=""></a>
      ...
      <div class="container">      
        <div class="row space-100">
          ...
          <div class="col-lg-5 col-md-12 col-xs-12">
            <div class="intro-img">
              <img src="../static/img/intro-mobile.png" alt="">
            </div>            
          </div>
        </div> 
      </div>             
    ...
    <div id="app-features" class="section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12 col-xs-12">
            <div class="show-box">
              <img src="../static/img/features/app.png" alt="">
            </div>
          </div>
          <div class="col-lg-4 col-md-12 col-xs-12">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="img-thumb wow fadeInLeft" data-wow-delay="0.3s">
              <img class="img-fluid" src="../static/img/features/img1.png" alt="">
            </div>
          </div>
          <div class="col-lg-6 col-md-12 col-sm-12">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12">
           ...
           <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="img-thumb wow fadeInLeft" data-wow-delay="1.2s">
              <img class="img-fluid" src="../static/img/features/img2.png" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="touch-slider owl-carousel">
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="../static/img/screenshot/img-1.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="../static/img/screenshot/img-2.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="../static/img/screenshot/img-3.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="../static/img/screenshot/img-4.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="../static/img/screenshot/img-5.png" alt="">
              </div>
            </div>
            <div class="item">
              <div class="screenshot-thumb">
                <img class="img-fluid" src="../static/img/screenshot/img-6.png" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.3s">
              <div class="team-thumb">
                <img src="../static/img/team/team2.jpg" alt="">
                <ul class="social-list">
                  <li class="facebook"><a href="#"><i class="lni-facebook-filled"></i></a></li>
                  <li class="twitter"><a href="#"><i class="lni-twitter-filled"></i></a></li>
                  <li class="google-plus"><a href="#"><i class="lni-google-plus"></i></a></li>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.4s">
              <div class="team-thumb">
                <img src="../static/img/team/team3.jpg" alt="">
                <ul class="social-list">
                  <li class="facebook"><a href="#"><i class="lni-facebook-filled"></i></a></li>
                  <li class="twitter"><a href="#"><i class="lni-twitter-filled"></i></a></li>
                  <li class="google-plus"><a href="#"><i class="lni-google-plus"></i></a></li>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.5s">
              <div class="team-thumb">
                <img src="../static/img/team/team4.jpg" alt="">
                <ul class="social-list">
                  <li class="facebook"><a href="#"><i class="lni-facebook-filled"></i></a></li>
                  <li class="twitter"><a href="#"><i class="lni-twitter-filled"></i></a></li>
                  <li class="google-plus"><a href="#"><i class="lni-google-plus"></i></a></li>
      ...
      <div class="container">
        ...
        <div class="row" id="clients-scroller">
          <div class="client-item-wrapper">
            <img src="../static/img/clients/img1.png" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="../static/img/clients/img2.png" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="../static/img/clients/img3.png" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="../static/img/clients/img4.png" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="../static/img/clients/img5.png" alt="">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-xs-12">            
            <div class="download-thumb wow fadeInLeft" data-wow-delay="0.2s">
              <img class="img-fluid" src="../static/img/mac.png" alt="">
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-xs-12">
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="../static/img/blog/img1.jpg" alt="">
                </a>   
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="../static/img/blog/img2.jpg" alt="">
                </a>   
                <div class="author-img">
                  <img src="../static/img/blog/author.png" alt="">
                </div>             
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="../static/img/blog/img3.jpg" alt="">
                </a>   
                <div class="author-img">
                  <img src="../static/img/blog/author.png" alt="">
                </div>             
